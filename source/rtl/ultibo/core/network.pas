...
begin
 ...
 case AType of
  ...
  MEDIA_TYPE_IEEE80211:Result:='MEDIA_TYPE_IEEE80211';
  MEDIA_TYPE_LOOPBACK:Result:='MEDIA_TYPE_LOOPBACK';
  MEDIA_TYPE_PPP:Result:='MEDIA_TYPE_PPP';
  MEDIA_TYPE_SLIP:Result:='MEDIA_TYPE_SLIP';
 end; 
end;
...
begin
 ...
 case AType of
  ...
  PACKET_TYPE_8021Q:Result:='PACKET_TYPE_8021Q';
  PACKET_TYPE_IPX:Result:='PACKET_TYPE_IPX';
  PACKET_TYPE_EAPOL:Result:='PACKET_TYPE_EAPOL';
  PACKET_TYPE_RSN:Result:='PACKET_TYPE_RSN';
  PACKET_TYPE_TDLS:Result:='PACKET_TYPE_TDLS';
  PACKET_TYPE_RAW:Result:='PACKET_TYPE_RAW';
  PACKET_TYPE_LLC:Result:='PACKET_TYPE_LLC';
 end; 
end;
