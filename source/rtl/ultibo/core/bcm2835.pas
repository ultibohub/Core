...
const
 ...
 BCM2835_CM_CTL_SRC_GND        = (0 shl 0); {Clock source - GND}
 BCM2835_CM_CTL_SRC_OSC        = (1 shl 0); {Clock source - Oscillator}
 BCM2835_CM_CTL_SRC_TESTDEBUG0 = (2 shl 0); {Clock source - Testdebug0}
 BCM2835_CM_CTL_SRC_TESTDEBUG1 = (3 shl 0); {Clock source - Testdebug1}
 BCM2835_CM_CTL_SRC_PLLAPER    = (4 shl 0); {Clock source - PLLA per}
 BCM2835_CM_CTL_SRC_PLLCPER    = (5 shl 0); {Clock source - PLLC per}
 BCM2835_CM_CTL_SRC_PLLDPER    = (6 shl 0); {Clock source - PLLD per}
 BCM2835_CM_CTL_SRC_HDMIAUX    = (7 shl 0); {Clock source - HDMI auxiliary}
