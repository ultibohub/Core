...
const
 ...
 {ARM Doorbell}
 BCM2837_DOORBELL_REGS_BASE     = BCM2837_PERIPHERALS_BASE + $B840;
 
 {ARM Mailbox 0}
 BCM2837_MAILBOX0_REGS_BASE     = BCM2837_PERIPHERALS_BASE + $B880;
 
 {ARM Mailbox 1}
 BCM2837_MAILBOX1_REGS_BASE     = BCM2837_PERIPHERALS_BASE + $B8A0;
 ...
 BCM2837_SDHOST_REGS_BASE       = BCM2837_MMCI0_REGS_BASE;
 ...
 {Pixel Valve 0}
 BCM2837_PIXELVALVE0_REGS_BASE  = BCM2837_PERIPHERALS_BASE + $206000;
 
 {Pixel Valve 1}
 BCM2837_PIXELVALVE1_REGS_BASE  = BCM2837_PERIPHERALS_BASE + $207000;

 {DPI (Display Parallel Interface)}
 BCM2837_DPI_REGS_BASE          = BCM2837_PERIPHERALS_BASE + $208000;

 {DSI0 (Display Serial Interface}
 BCM2837_DSI0_REGS_BASE         = BCM2837_PERIPHERALS_BASE + $209000;
 ...
 BCM2837_UART1_REGS_BASE        = BCM2837_PERIPHERALS_BASE + $215040;
 BCM2837_SPI1_REGS_BASE         = BCM2837_PERIPHERALS_BASE + $215080;
 BCM2837_SPI2_REGS_BASE         = BCM2837_PERIPHERALS_BASE + $2150C0;
 ...
 {HVS}
 BCM2837_HVS_REGS_BASE          = BCM2837_PERIPHERALS_BASE + $400000;
 
 {SMI (Firmware KMS)}
 BCM2837_SMI_REGS_BASE          = BCM2837_PERIPHERALS_BASE + $600000;
 
 {DSI1 (Display Serial Interface}
 BCM2837_DSI1_REGS_BASE         = BCM2837_PERIPHERALS_BASE + $700000;
 ...
 {VEC}
 BCM2837_VEC_REGS_BASE          = BCM2837_PERIPHERALS_BASE + $806000;
 
 {Pixel Valve 2}
 BCM2837_PIXELVALVE2_REGS_BASE  = BCM2837_PERIPHERALS_BASE + $807000;
 
 {HDMI}
 BCM2837_HDMI_REGS_BASE         = BCM2837_PERIPHERALS_BASE + $902000;
...
const
 ...
 {SDHOST}
 BCM2837_IRQ_SDHOST         = 56; {Also available as IRQ 82 in the IRQ_basic_pending register} 
 ...
 {ARM SDHOST}
 BCM2837_IRQ_ARM_SDHOST       = 82;  {ARM IRQ 18}
...
const
 ...
 BCM2837_DMA_DREQ_BSCSPITX     = 8;  {BSC/SPI Slave}
 BCM2837_DMA_DREQ_BSCSPIRX     = 9;  {BSC/SPI Slave}
 BCM2837_DMA_DREQ_RESERVED1    = 10;
 BCM2837_DMA_DREQ_EMMC         = 11; {SDHCI}
 BCM2837_DMA_DREQ_UARTTX       = 12;
 BCM2837_DMA_DREQ_SDHOST       = 13; {SDHOST}
...
const
 ...
 BCM2837_I2CSPI_DR_RXFLEVEL_MASK  = ($1F shl 27); {RX FIFO Level}
 BCM2837_I2CSPI_DR_RXFLEVEL_SHIFT = 27;
 BCM2837_I2CSPI_DR_TXFLEVEL_MASK  = ($1F shl 22); {TX FIFO Level}
 BCM2837_I2CSPI_DR_TXFLEVEL_SHIFT = 22;
 BCM2837_I2CSPI_DR_RXBUSY         = (1 shl 21);   {Receive Busy}
 BCM2837_I2CSPI_DR_TXFE           = (1 shl 20);   {TX FIFO Empty}
 BCM2837_I2CSPI_DR_RXFF           = (1 shl 19);   {RX FIFO Full}
 BCM2837_I2CSPI_DR_TXFF           = (1 shl 18);   {TX FIFO Full}
 BCM2837_I2CSPI_DR_RXFE           = (1 shl 17);   {RX FIFO Empty}
 BCM2837_I2CSPI_DR_TXBUSY         = (1 shl 16);   {Transmit Busy}
 BCM2837_I2CSPI_DR_UE             = (1 shl 9);    {TX Underrun Error}
 BCM2837_I2CSPI_DR_OE             = (1 shl 8);    {RX Overrun Error}
 BCM2837_I2CSPI_DR_DATA_MASK      = ($FF shl 0);  {Received/Transferred data}

 {I2C / SPI Slave RSR (Status) register bits (See 11.2)}
 BCM2837_I2CSPI_RSR_UE = (1 shl 1); {TX Underrun Error}
 BCM2837_I2CSPI_RSR_OE = (1 shl 0); {RX Overrun Error}

 {I2C / SPI Slave SLV (Slave) register bits (See 11.2)}
 BCM2837_I2CSPI_SLV_ADDR_MASK = ($7F shl 0); {I2C Slave Address}

 {I2C / SPI Slave CR (Control) register bits (See 11.2)}
 BCM2837_I2CSPI_CR_INV_TXF  = (1 shl 13); {Inverse TX status flags}
 BCM2837_I2CSPI_CR_TESTFIFO = (1 shl 11); {TEST FIFO}
 BCM2837_I2CSPI_CR_INV_RXF  = (1 shl 10); {Inverse RX status flags}
 BCM2837_I2CSPI_CR_RXE      = (1 shl 9);  {Receive Enable}
 BCM2837_I2CSPI_CR_TXE      = (1 shl 8);  {Transmit Enable}
 BCM2837_I2CSPI_CR_BRK      = (1 shl 7);  {Break current operation}
 BCM2837_I2CSPI_CR_CPOL     = (1 shl 4);  {Clock Polarity}
 BCM2837_I2CSPI_CR_CPHA     = (1 shl 3);  {Clock Phase}
 BCM2837_I2CSPI_CR_I2C      = (1 shl 2);  {I2C Enable}
 BCM2837_I2CSPI_CR_SPI      = (1 shl 1);  {SPI Enable}
 BCM2837_I2CSPI_CR_EN       = (1 shl 0);  {Enable Device}

 {I2C / SPI Slave FR (Flags) register bits (See 11.2)}
 BCM2837_I2CSPI_RXFLEVEL_MASK  = ($1F shl 11); {RX FIFO Level}
 BCM2837_I2CSPI_RXFLEVEL_SHIFT = 11;
 BCM2837_I2CSPI_TXFLEVEL_MASK  = ($1F shl 6);  {TX FIFO Level}
 BCM2837_I2CSPI_TXFLEVEL_SHIFT = 6;
 BCM2837_I2CSPI_FR_RXBUSY      = (1 shl 5);    {Receive Busy}
 BCM2837_I2CSPI_FR_TXFE        = (1 shl 4);    {TX FIFO Empty}
 BCM2837_I2CSPI_FR_RXFF        = (1 shl 3);    {RX FIFO Full}
 BCM2837_I2CSPI_FR_TXFF        = (1 shl 2);    {TX FIFO Full}
 BCM2837_I2CSPI_FR_RXFE        = (1 shl 1);    {RX FIFO Empty}
 BCM2837_I2CSPI_FR_TXBUSY      = (1 shl 0);    {Transmit Busy}

 {I2C / SPI Slave IFLS (Interrupt FIFO Level Select) register bits (See 11.2)}
 BCM2837_I2CSPI_IFLS_RXIFLSEL_MASK  = (7 shl 3); {RX Interrupt FIFO Level Select}
 BCM2837_I2CSPI_IFLS_RXIFLSEL_SHIFT = 3;
 BCM2837_I2CSPI_IFLS_RXIFLSEL1_8    = (0 shl 3); {000 RX FIFO gets 1/8 full}
 BCM2837_I2CSPI_IFLS_RXIFLSEL1_4    = (1 shl 3); {001 RX FIFO gets 1/4 full}
 BCM2837_I2CSPI_IFLS_RXIFLSEL1_2    = (2 shl 3); {010 RX FIFO gets 1/2 full}
 BCM2837_I2CSPI_IFLS_RXIFLSEL3_4    = (3 shl 3); {011 RX FIFO gets 3/4 full}
 BCM2837_I2CSPI_IFLS_RXIFLSEL7_8    = (4 shl 3); {100 RX FIFO gets 7/8 full}
 BCM2837_I2CSPI_IFLS_TXIFLSEL_MASK  = (7 shl 0); {TX Interrupt FIFO Level Select}
 BCM2837_I2CSPI_IFLS_TXIFLSEL_SHIFT = 0;
 BCM2837_I2CSPI_IFLS_TXIFLSEL1_8    = (0 shl 0); {000 TX FIFO gets 1/8 full}
 BCM2837_I2CSPI_IFLS_TXIFLSEL1_4    = (1 shl 0); {001 TX FIFO gets 1/4 full}
 BCM2837_I2CSPI_IFLS_TXIFLSEL1_2    = (2 shl 0); {010 TX FIFO gets 1/2 full}
 BCM2837_I2CSPI_IFLS_TXIFLSEL3_4    = (3 shl 0); {011 TX FIFO gets 3/4 full}
 BCM2837_I2CSPI_IFLS_TXIFLSEL7_8    = (4 shl 0); {100 TX FIFO gets 7/8 full}

 {I2C / SPI Slave IMSC (Interrupt Mask Set Clear) register bits (See 11.2)}
 BCM2837_I2CSPI_IMSC_OEIM = (1 shl 3); {Overrun error interrupt mask}
 BCM2837_I2CSPI_IMSC_BEIM = (1 shl 2); {Break error interrupt mask}
 BCM2837_I2CSPI_IMSC_TXIM = (1 shl 1); {Transmit interrupt mask}
 BCM2837_I2CSPI_IMSC_RXIM = (1 shl 0); {Receive interrupt mask}

 {I2C / SPI Slave RIS (Raw Interrupt Status) register bits (See 11.2)}
 BCM2837_I2CSPI_RIS_OERIS = (1 shl 3); {Overrun error interrupt status}
 BCM2837_I2CSPI_RIS_BERIS = (1 shl 2); {Break error interrupt status}
 BCM2837_I2CSPI_RIS_TXRIS = (1 shl 1); {Transmit interrupt status}
 BCM2837_I2CSPI_RIS_RXRIS = (1 shl 0); {Receive interrupt status}

 {I2C / SPI Slave MIS (Masked Interrupt Status) register bits (See 11.2)}
 BCM2837_I2CSPI_MIS_OEMIS = (1 shl 3); {Overrun error masked interrupt status}
 BCM2837_I2CSPI_MIS_BEMIS = (1 shl 2); {Break error masked interrupt status}
 BCM2837_I2CSPI_MIS_TXMIS = (1 shl 1); {Transmit masked interrupt status}
 BCM2837_I2CSPI_MIS_RXMIS = (1 shl 0); {Receive masked interrupt status}

 {I2C / SPI Slave ICR (Interrupt Clear Register) register bits (See 11.2)}
 BCM2837_I2CSPI_ICR_OEIC = (1 shl 3); {Overrun error interrupt clear}
 BCM2837_I2CSPI_ICR_BEIC = (1 shl 2); {Break error interrupt clear}
 BCM2837_I2CSPI_ICR_TXIC = (1 shl 1); {Transmit interrupt clear}
 BCM2837_I2CSPI_ICR_RXIC = (1 shl 0); {Receive interrupt clear}
...
const
 ...
 BCM2837_PM_RSTS_RASPBERRYPI_HALT  = $00000555; {Special value to tell the Raspberry Pi firmware not to reboot, sets Boot Partition to 63 (0x3f)}
...
const
 ...
 {BCM2837 mailbox configuration flags}
 BCM2837_MAILBOX_CONFIG_IRQENABLE = $00000001;
 ...
 BCM2837_MBOX_TAG_EXECUTE_QPU       = $00030011; {Execute an assembled block of code using one or more Quad Processing Units (QPUs)}
 BCM2837_MBOX_TAG_ENABLE_QPU        = $00030012; {Enable the Quad Processing Units (QPUs)}
 ...
 BCM2837_MBOX_TAG_GET_THROTTLED     = $00030046;
 
 BCM2837_MBOX_TAG_GET_CLOCK_MEASURED = $00030047;

 BCM2837_MBOX_TAG_GET_PERIPH_REG    = $00030045;
 BCM2837_MBOX_TAG_SET_PERIPH_REG    = $00038045;

 BCM2837_MBOX_TAG_GET_POE_HAT_VAL   = $00030049;
 BCM2837_MBOX_TAG_SET_POE_HAT_VAL   = $00038049;

 BCM2837_MBOX_TAG_NOTIFY_REBOOT     = $00030048;
 BCM2837_MBOX_TAG_NOTIFY_XHCI_RESET = $00030058;

 BCM2837_MBOX_TAG_GET_BOOT_MODE     = $0003005b; {Get the boot mode that was used by the firmware to load the kernel (1 = SD, 4 = MSD etc)}
 
 BCM2837_MBOX_TAG_GET_REBOOT_FLAGS  = $00030064;
 BCM2837_MBOX_TAG_SET_REBOOT_FLAGS  = $00038064;
 
 BCM2837_MBOX_TAG_NOTIFY_DISPLAY_DONE = $00030066;
 ...
 BCM2837_MBOX_TAG_TEST_BLANK_SCREEN = $00044002; {Previously BCM2837_MBOX_TAG_TST_BLANK_SCREEN}
 ...
 BCM2837_MBOX_TAG_TEST_PITCH        = $00044008; {Previously BCM2837_MBOX_TAG_TST_PITCH}
 ...
 BCM2837_MBOX_TAG_TEST_LAYER        = $0004400c; {Previously BCM2837_MBOX_TAG_TST_LAYER}
 BCM2837_MBOX_TAG_SET_LAYER         = $0004800c;
 
 BCM2837_MBOX_TAG_GET_TRANSFORM     = $0004000d;
 BCM2837_MBOX_TAG_TEST_TRANSFORM    = $0004400d; {Previously BCM2837_MBOX_TAG_TST_TRANSFORM}
 BCM2837_MBOX_TAG_SET_TRANSFORM     = $0004800d;
 
 BCM2837_MBOX_TAG_TEST_VSYNC        = $0004400e; {Previously BCM2837_MBOX_TAG_TST_VSYNC}
 BCM2837_MBOX_TAG_SET_VSYNC         = $0004800e;
 
 BCM2837_MBOX_TAG_SET_BACKLIGHT     = $0004800f;
 
 BCM2837_MBOX_TAG_GET_TOUCHBUF      = $0004000f;
 BCM2837_MBOX_TAG_SET_TOUCHBUF      = $0004801f;
 ...
 BCM2837_BOARD_REV_2B_3     = $00A22042;
 
 BCM2837_BOARD_REV_3B_1     = $00A02082;
 BCM2837_BOARD_REV_3B_2     = $00A22082;
 BCM2837_BOARD_REV_3B_3     = $00A32082;
 
 BCM2837_BOARD_REV_CM3_1    = $00A020A0;
 BCM2837_BOARD_REV_CM3_2    = $00A220A0;
...
const
 ...
 BCM2837_GPIO_SIGNATURE = $6770696F; {The ASCII value 'GPIO' returned when reading from a write only register}
...
type
 ...
 PBCM2837Mailbox1Registers = ^TBCM2837Mailbox1Registers;
 TBCM2837Mailbox1Registers = record
...
type
 ...
 PBCM2837MailboxTagGetClockMeasuredRate = ^TBCM2837MailboxTagGetClockMeasuredRate;
 TBCM2837MailboxTagGetClockMeasuredRate = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagGetClockRateRequest);
  1:(Response:TBCM2837MailboxTagClockRateResponse);
 ...
 TBCM2837MailboxTagExecuteQPUResponse = record
  Status:LongWord; {0 is Success / 0x80000000 is Timeout}
 end;
 
 PBCM2837MailboxTagExecuteQPU = ^TBCM2837MailboxTagExecuteQPU;
 TBCM2837MailboxTagExecuteQPU = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagExecuteQPURequest);
  1:(Response:TBCM2837MailboxTagExecuteQPUResponse);
 end;
 
 {Enable QPU}
 TBCM2837MailboxTagEnableQPURequest = record
  Enable:LongWord; 
 end;

 TBCM2837MailboxTagEnableQPUResponse = record
  Status:LongWord;  {0 is Success}
 end;
 
 PBCM2837MailboxTagEnableQPU = ^TBCM2837MailboxTagEnableQPU;
 TBCM2837MailboxTagEnableQPU = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagEnableQPURequest);
  1:(Response:TBCM2837MailboxTagEnableQPUResponse);
 end;
 ...
 {Get GPIO State}
 TBCM2837MailboxTagGPIOStateRequest = record
  GPIO:LongWord;
  State:LongWord;
 end;
 
 TBCM2837MailboxTagGPIOStateResponse = record
  GPIO:LongWord;
  State:LongWord;
 end;
 
 PBCM2837MailboxTagGetGPIOState = ^TBCM2837MailboxTagGetGPIOState;
 TBCM2837MailboxTagGetGPIOState = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagGPIOStateRequest);
  1:(Response:TBCM2837MailboxTagGPIOStateResponse);
 end;
 
 {Set GPIO State}
 PBCM2837MailboxTagSetGPIOState = ^TBCM2837MailboxTagSetGPIOState;
 TBCM2837MailboxTagSetGPIOState = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagGPIOStateRequest);
  1:(Response:TBCM2837MailboxTagGPIOStateResponse);
 ...
 {Get GPIO Config}
 TBCM2837MailboxTagGetGPIOConfigRequest = record
  GPIO:LongWord;
  Direction:LongWord;
  Polarity:LongWord;
  Terminator:LongWord;
 ...
 TBCM2837MailboxTagGetGPIOConfigResponse = record
  GPIO:LongWord;
  Direction:LongWord;
  Polarity:LongWord;
  Terminator:LongWord;
 ...
 PBCM2837MailboxTagGetGPIOConfig = ^TBCM2837MailboxTagGetGPIOConfig;
 TBCM2837MailboxTagGetGPIOConfig = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagGetGPIOConfigRequest);
  1:(Response:TBCM2837MailboxTagGetGPIOConfigResponse);
 end;
 
 {Set GPIO Config}
 TBCM2837MailboxTagSetGPIOConfigRequest = record
  GPIO:LongWord;
  Direction:LongWord;
  Polarity:LongWord;
  Terminator:LongWord;
 ...
 TBCM2837MailboxTagSetGPIOConfigResponse = record
  GPIO:LongWord;
  Direction:LongWord;
  Polarity:LongWord;
  Terminator:LongWord;
 ...
 PBCM2837MailboxTagSetGPIOConfig = ^TBCM2837MailboxTagSetGPIOConfig;
 TBCM2837MailboxTagSetGPIOConfig = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagSetGPIOConfigRequest);
  1:(Response:TBCM2837MailboxTagSetGPIOConfigResponse);
 end;
  
 {Get Throttled}
 TBCM2837MailboxTagGetThrottledRequest = record
  Value:LongWord;
 end;
 
 TBCM2837MailboxTagGetThrottledResponse = record
  Value:LongWord;
 end;
 
 PBCM2837MailboxTagGetThrottled = ^TBCM2837MailboxTagGetThrottled;
 TBCM2837MailboxTagGetThrottled = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagGetThrottledRequest);
  1:(Response:TBCM2837MailboxTagGetThrottledResponse);
 end;

 {Get Boot Mode}
 TBCM2837MailboxTagGetBootModeResponse = record
  BootMode:LongWord;
  SignedBoot:LongWord;
 end;

 PBCM2837MailboxTagGetBootMode = ^TBCM2837MailboxTagGetBootMode;
 TBCM2837MailboxTagGetBootMode = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagNoRequest);
  1:(Response:TBCM2837MailboxTagGetBootModeResponse);
 end;
 ...
 {Get Layer}
 TBCM2837MailboxTagLayerRequest = record
  Layer:LongInt;
 end;

 TBCM2837MailboxTagLayerResponse = record
  Layer:LongInt; 
 end;

 PBCM2837MailboxTagGetLayer = ^TBCM2837MailboxTagGetLayer;
 TBCM2837MailboxTagGetLayer = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagNoRequest);
  1:(Response:TBCM2837MailboxTagLayerResponse);
 end;
 
 {Test Layer}
 PBCM2837MailboxTagTestLayer = ^TBCM2837MailboxTagTestLayer;
 TBCM2837MailboxTagTestLayer = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagLayerRequest);
  1:(Response:TBCM2837MailboxTagLayerResponse);
 end;
 
 {Set Layer}
 PBCM2837MailboxTagSetLayer = ^TBCM2837MailboxTagSetLayer;
 TBCM2837MailboxTagSetLayer = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagLayerRequest);
  1:(Response:TBCM2837MailboxTagLayerResponse);
 ...
 {Set Touch Buffer}
 TBCM2837MailboxTagSetTouchRequest = record
  Address:LongWord; 
 end;
 
 TBCM2837MailboxTagSetTouchResponse = record
  Status:LongWord; 
 end;
 
 PBCM2837MailboxTagSetTouch = ^TBCM2837MailboxTagSetTouch;
 TBCM2837MailboxTagSetTouch = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagSetTouchRequest);
  1:(Response:TBCM2837MailboxTagSetTouchResponse);
 end;
 ...
 TBCM2837MailboxTagSetVirtualGPIORequest = record
  Address:LongWord; 
 end;
 ...
 PBCM2837MailboxTagSetVirtualGPIO = ^TBCM2837MailboxTagSetVirtualGPIO;
 TBCM2837MailboxTagSetVirtualGPIO = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
 ...
 {VCHIQ Init}
 TBCM2837MailboxTagVCHIQInitRequest = record
  Address:LongWord; 
 end;

 TBCM2837MailboxTagVCHIQInitResponse = record
  Status:LongWord;  {0 is Success}
 end;
 
 PBCM2837MailboxTagVCHIQInit = ^TBCM2837MailboxTagVCHIQInit;
 TBCM2837MailboxTagVCHIQInit = record
  Header:TBCM2837MailboxTagHeader;
  case Integer of
  0:(Request:TBCM2837MailboxTagVCHIQInitRequest);
  1:(Response:TBCM2837MailboxTagVCHIQInitResponse);
 end;
