...
begin
 ...
 case Facility of
  ...
  LOGGING_FACILITY_PCI:Result:=SYSLOG_FACILITY_SYSTEM;
  LOGGING_FACILITY_VIRTIO:Result:=SYSLOG_FACILITY_SYSTEM;
  LOGGING_FACILITY_BLUETOOTH:Result:=SYSLOG_FACILITY_SYSTEM;
  LOGGING_FACILITY_JOYSTICK:Result:=SYSLOG_FACILITY_SYSTEM;
