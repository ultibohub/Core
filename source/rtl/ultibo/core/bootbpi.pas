{
Ultibo Initialization code for Banana Pi.
...
uses GlobalConfig,GlobalConst,GlobalTypes,Platform,PlatformBPi,PlatformARM,PlatformARMv7,Threads{$IFDEF CONSOLE_EARLY_INIT},Devices,Framebuffer,Console{$ENDIF}{$IFDEF LOGGING_EARLY_INIT},Logging{$ENDIF}; 
...
//See also: NetBSD arch\evbarm\awin\awin_start.S
