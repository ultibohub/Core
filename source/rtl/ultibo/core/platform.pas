...
function TInterruptEntry.GetIsChained:Boolean;
begin
 {}
 Result:=(FFlags and INTERRUPT_FLAG_SHARED) <> 0;
end;
...
procedure TInterruptEntry.SetIsChained(AValue:Boolean);
begin
 {}
 if AValue then
  begin
   FFlags:=FFlags or INTERRUPT_FLAG_CHAINED;
  end
 else
  begin
   FFlags:=FFlags and not INTERRUPT_FLAG_CHAINED;
  end;  
end;
