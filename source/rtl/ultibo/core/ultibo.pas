...
const
 ...
 FILE_ATTRIBUTE_READONLY            = GlobalConst.FILE_ATTRIBUTE_READONLY;
 FILE_ATTRIBUTE_HIDDEN              = GlobalConst.FILE_ATTRIBUTE_HIDDEN;
 FILE_ATTRIBUTE_SYSTEM              = GlobalConst.FILE_ATTRIBUTE_SYSTEM;
 FILE_ATTRIBUTE_DIRECTORY           = GlobalConst.FILE_ATTRIBUTE_DIRECTORY;
 FILE_ATTRIBUTE_ARCHIVE             = GlobalConst.FILE_ATTRIBUTE_ARCHIVE;
 FILE_ATTRIBUTE_DEVICE              = GlobalConst.FILE_ATTRIBUTE_DEVICE;
 FILE_ATTRIBUTE_NORMAL              = GlobalConst.FILE_ATTRIBUTE_NORMAL;
 FILE_ATTRIBUTE_TEMPORARY           = GlobalConst.FILE_ATTRIBUTE_TEMPORARY;
 FILE_ATTRIBUTE_SPARSE_FILE         = GlobalConst.FILE_ATTRIBUTE_SPARSE_FILE;
 FILE_ATTRIBUTE_REPARSE_POINT       = GlobalConst.FILE_ATTRIBUTE_REPARSE_POINT;
 FILE_ATTRIBUTE_COMPRESSED          = GlobalConst.FILE_ATTRIBUTE_COMPRESSED;
 FILE_ATTRIBUTE_OFFLINE             = GlobalConst.FILE_ATTRIBUTE_OFFLINE;
 FILE_ATTRIBUTE_NOT_CONTENT_INDEXED = GlobalConst.FILE_ATTRIBUTE_NOT_CONTENT_INDEXED;
 FILE_ATTRIBUTE_ENCRYPTED           = GlobalConst.FILE_ATTRIBUTE_ENCRYPTED;

const
 {Volume Info Constants}
 FILE_CASE_SENSITIVE_SEARCH         = GlobalConst.FILE_CASE_SENSITIVE_SEARCH;
 FILE_CASE_PRESERVED_NAMES          = GlobalConst.FILE_CASE_PRESERVED_NAMES;
 FILE_UNICODE_ON_DISK               = GlobalConst.FILE_UNICODE_ON_DISK;
 FILE_PERSISTENT_ACLS               = GlobalConst.FILE_PERSISTENT_ACLS;
 FILE_FILE_COMPRESSION              = GlobalConst.FILE_FILE_COMPRESSION;
 FILE_VOLUME_QUOTAS                 = GlobalConst.FILE_VOLUME_QUOTAS;
 FILE_SUPPORTS_SPARSE_FILES         = GlobalConst.FILE_SUPPORTS_SPARSE_FILES;
 FILE_SUPPORTS_REPARSE_POINTS       = GlobalConst.FILE_SUPPORTS_REPARSE_POINTS;
 FILE_SUPPORTS_REMOTE_STORAGE       = GlobalConst.FILE_SUPPORTS_REMOTE_STORAGE;
 FILE_VOLUME_IS_COMPRESSED          = GlobalConst.FILE_VOLUME_IS_COMPRESSED;
 FILE_SUPPORTS_OBJECT_IDS           = GlobalConst.FILE_SUPPORTS_OBJECT_IDS;
 FILE_SUPPORTS_ENCRYPTION           = GlobalConst.FILE_SUPPORTS_ENCRYPTION;
 FILE_NAMED_STREAMS                 = GlobalConst.FILE_NAMED_STREAMS;
 FILE_READ_ONLY_VOLUME              = GlobalConst.FILE_READ_ONLY_VOLUME;
