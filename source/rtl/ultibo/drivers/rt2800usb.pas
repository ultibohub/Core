...
begin
 ...
 WorkBool:=StrToBoolDef(EnvironmentGet('RT2800USB_FIRMWARE_INTERNAL'),RT2800USB_FIRMWARE_INTERNAL);
 if WorkBool <> RT2800USB_FIRMWARE_INTERNAL then RT2800USB_FIRMWARE_INTERNAL:=WorkBool;

 {RT2800USB_HARDWARE_ENCRYPTION_DISABLED}
 WorkBool:=StrToBoolDef(EnvironmentGet('RT2800USB_HARDWARE_ENCRYPTION_DISABLED'),RT2800USB_HARDWARE_ENCRYPTION_DISABLED);
 if WorkBool <> RT2800USB_HARDWARE_ENCRYPTION_DISABLED then RT2800USB_HARDWARE_ENCRYPTION_DISABLED:=WorkBool;
