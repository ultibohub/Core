...
so the color looks great up to 80 degrees off-axis in any direction. The TFT driver (ST7789) is very similar to the popular ST7735.
...
uses GlobalConfig, GlobalConst, GlobalTypes, Platform, Threads, Devices,
  GPIO, PWM, SPI, Framebuffer, ST77XX, STMPE, SysUtils;

{==============================================================================}
{Global definitions}
{$INCLUDE ..\core\GlobalDefines.inc}
{{$INCLUDE C:\Ultibo\Core\fpc\3.2.2\source\rtl\ultibo\core\GlobalDefines.inc}
{==============================================================================}
const
 ...
 IPSTFT19_LCD_BL    = GPIO_PIN_18; {STMPE GPIO} 
...
function IPSTFT19Start(Rotation:LongWord;const Device:String;DisplaySelect:word):THandle;
{Start the IPSTFT19 driver, Backlight (GPIO) and Framebuffer devices associated with the display}
...
function IPSTFT19Stop(Handle:THandle):Boolean;
{Stop the IPSTFT19 driver, Backlight (GPIO) and Framebuffer devices associated with the display}
