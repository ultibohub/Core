{
LDM XPT2046 / TI ADS7843 TouchScreen Driver
...
LDM / TI TouchScreen Driver
===========================
 
 The LDM / TI devices are 12-bit sampling A-to-D converters with an asynchronous serial interface and low
 on-resistance switches for driving touch screens. This driver caters for the following devices:
...
{==============================================================================}
const
 {LDMTI specific constants}
 LDMTI_TOUCH_DESCRIPTION = 'LDM/TI Touch Controller';  {Description of LDMTI Touch device}
