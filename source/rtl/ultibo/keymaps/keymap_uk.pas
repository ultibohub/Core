...
==========
 ...
 UK keyboard layout - https://www.microsoft.com/resources/msdn/goglobal/keyboards/kbduk.html
 
 
UK English Keymap (UK)
======================
...
{==============================================================================}
{const}
 {Keymap_UK specific constants}

{==============================================================================}
{type}
 {Keymap_UK specific types}

{==============================================================================}
{var}
 {Keymap_UK specific variables}

{==============================================================================}
{Initialization Functions}
procedure Keymap_UKInit;
...
var
 {Keymap_UK specific variables}
 Keymap_UKInitialized:Boolean;
 
var 
 {Keymap UK - UK English}
 KEYMAP_UK_HEADER:TKeymapHeader = (
 ...
 KEYMAP_UK_DATA:TKeymapData = (
  ...
  Data:({SCAN_CODE_NONE                   } (KEY_CODE_NONE,                 KEY_CODE_NONE,                 KEY_CODE_NONE,                 KEY_CODE_NONE),
        ...
        {SCAN_CODE_2                      } (KEY_CODE_2,                    KEY_CODE_QUOTATION,            KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_3                      } (KEY_CODE_3,                    KEY_CODE_POUND,                KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_4                      } (KEY_CODE_4,                    KEY_CODE_DOLLAR,               KEY_CODE_EURO,                 KEY_CODE_NONE),
        ...
        {SCAN_CODE_BACKSLASH              } (KEY_CODE_NUMBER,               KEY_CODE_TILDE,                KEY_CODE_NONE,                 KEY_CODE_NONE),
        ...
        {SCAN_CODE_APOSTROPHE             } (KEY_CODE_APOSTROPHE,           KEY_CODE_AT,                   KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_GRAVE                  } (KEY_CODE_GRAVE,                KEY_CODE_NOT,                  KEY_CODE_BROKEN_BAR,           KEY_CODE_NONE),
...
begin
 {}
 {Check Initialized}
 if Keymap_UKInitialized then Exit;

 {Load UK English (UK) Keymap}
 KeymapHandle:=KeymapLoad(@KEYMAP_UK_HEADER,@KEYMAP_UK_DATA,SizeOf(TKeymapData));
 if KeymapHandle = INVALID_HANDLE_VALUE then
  begin
   if PLATFORM_LOG_ENABLED then PlatformLogError('Failed to load keymap UK');
  end;
  
 {Check Environment Variables}
 if (Uppercase(SysUtils.GetEnvironmentVariable('KEYMAP_DEFAULT')) = 'UK') or (Uppercase(KEYMAP_DEFAULT) = 'UK') then
  begin
   {Update Default}
   KEYMAP_DEFAULT:='UK';
