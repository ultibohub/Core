...
var
 ...
 KEYMAP_DE_DATA:TKeymapData = (
  ...
  Data:({SCAN_CODE_NONE                   } (KEY_CODE_NONE,                 KEY_CODE_NONE,                 KEY_CODE_NONE,                 KEY_CODE_NONE),
        ...
        {SCAN_CODE_Q                      } (KEY_CODE_Q,                    KEY_CODE_CAPITAL_Q,            KEY_CODE_AT,                   KEY_CODE_NONE),
        ...
        {SCAN_CODE_Y                      } (KEY_CODE_Z,                    KEY_CODE_CAPITAL_Z,            KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_Z                      } (KEY_CODE_Y,                    KEY_CODE_CAPITAL_Y,            KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_1                      } (KEY_CODE_1,                    KEY_CODE_EXCLAMATION,          KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_2                      } (KEY_CODE_2,                    KEY_CODE_QUOTATION,            KEY_CODE_SUPERSCRIPT_2,        KEY_CODE_NONE),
        {SCAN_CODE_3                      } (KEY_CODE_3,                    KEY_CODE_SECTION,              KEY_CODE_SUPERSCRIPT_3,        KEY_CODE_NONE),
        ...
        {SCAN_CODE_6                      } (KEY_CODE_6,                    KEY_CODE_AMPERSAND,            KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_7                      } (KEY_CODE_7,                    KEY_CODE_SLASH,                KEY_CODE_LEFT_BRACE,           KEY_CODE_NONE),
        {SCAN_CODE_8                      } (KEY_CODE_8,                    KEY_CODE_LEFT_BRACKET,         KEY_CODE_LEFT_SQUARE,          KEY_CODE_NONE),
        {SCAN_CODE_9                      } (KEY_CODE_9,                    KEY_CODE_RIGHT_BRACKET,        KEY_CODE_RIGHT_SQUARE,         KEY_CODE_NONE),
        {SCAN_CODE_0                      } (KEY_CODE_0,                    KEY_CODE_EQUALS,               KEY_CODE_RIGHT_BRACE,          KEY_CODE_NONE),
        ...
        {SCAN_CODE_MINUS                  } (KEY_CODE_SHARP_S,              KEY_CODE_QUESTION,             KEY_CODE_BACKSLASH,            KEY_CODE_NONE),
        {SCAN_CODE_EQUALS                 } (KEY_CODE_ACUTE,                KEY_CODE_GRAVE,                KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_LEFT_SQUARE            } (KEY_CODE_DIAERESIS_U,          KEY_CODE_CAPITAL_DIAERESIS_U,  KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_RIGHT_SQUARE           } (KEY_CODE_PLUS,                 KEY_CODE_ASTERISK,             KEY_CODE_TILDE,                KEY_CODE_NONE),
        {SCAN_CODE_BACKSLASH              } (KEY_CODE_NUMBER,               KEY_CODE_APOSTROPHE,           KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_NONUS_NUMBER           } (KEY_CODE_NUMBER,               KEY_CODE_APOSTROPHE,           KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_SEMICOLON              } (KEY_CODE_DIAERESIS_O,          KEY_CODE_CAPITAL_DIAERESIS_O,  KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_APOSTROPHE             } (KEY_CODE_DIAERESIS_A,          KEY_CODE_CAPITAL_DIAERESIS_A,  KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_GRAVE                  } (KEY_CODE_CARET,                KEY_CODE_DEGREE,               KEY_CODE_NONE,                 KEY_CODE_NONE),
        ...
        {SCAN_CODE_NONUS_BACKSLASH        } (KEY_CODE_LESSTHAN,             KEY_CODE_GREATERTHAN,          KEY_CODE_PIPE,                 KEY_CODE_NONE),
 ...
 KEYMAP_DE_CAPSKEYS:TKeymapCapskeys = (
  ...
  Keys:((First:SCAN_CODE_A;             Last:SCAN_CODE_Z),
        ...
        (First:SCAN_CODE_MINUS;         Last:SCAN_CODE_MINUS),
        ...
        (First:SCAN_CODE_COMMA;         Last:SCAN_CODE_PERIOD),
  ...
  Keys:((Key:SCAN_CODE_GRAVE; {Circumflex Accent (Normal)}
        ...
        (Key:SCAN_CODE_EQUALS; {Acute Accent (Normal)}
         ...
         Resolves:((Key:SCAN_CODE_A;              Index:KEYMAP_INDEX_NORMAL;              Code:KEY_CODE_ACUTE_A),
                   ...
                   (Key:SCAN_CODE_Z;              Index:KEYMAP_INDEX_NORMAL;              Code:KEY_CODE_ACUTE_Y),
                   (Key:SCAN_CODE_Z;              Index:KEYMAP_INDEX_SHIFT;               Code:KEY_CODE_CAPITAL_ACUTE_Y),
                   (Key:SCAN_CODE_NONE;           Index:KEYMAP_INDEX_NORMAL;              Code:KEY_CODE_NONE),
                   (Key:SCAN_CODE_NONE;           Index:KEYMAP_INDEX_NORMAL;              Code:KEY_CODE_NONE),
                   (Key:SCAN_CODE_NONE;           Index:KEYMAP_INDEX_NORMAL;              Code:KEY_CODE_NONE),
                   (Key:SCAN_CODE_NONE;           Index:KEYMAP_INDEX_NORMAL;              Code:KEY_CODE_NONE),
...
begin
 {}
 {Check Initialized}
 if Keymap_DEInitialized then Exit;

 {Load German (DE) Keymap}
 KeymapHandle:=KeymapLoadEx(@KEYMAP_DE_HEADER,@KEYMAP_DE_DATA,@KEYMAP_DE_CAPSKEYS,@KEYMAP_DE_DEADKEYS,SizeOf(TKeymapData),nil);
 if KeymapHandle = INVALID_HANDLE_VALUE then
  begin
   if PLATFORM_LOG_ENABLED then PlatformLogError('Failed to load keymap DE');
  end;
