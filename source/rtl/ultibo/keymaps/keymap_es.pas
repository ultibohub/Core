...
==========
 ...
 Spanish keyboard layout - https://www.microsoft.com/resources/msdn/goglobal/keyboards/kbdsp.html
...
{==============================================================================}
{const}
 {Keymap_ES specific constants}

{==============================================================================}
{type}
 {Keymap_ES specific types}

{==============================================================================}
{var}
 {Keymap_ES specific variables}

{==============================================================================}
{Initialization Functions}
procedure Keymap_ESInit;
...
var
 {Keymap_ES specific variables}
 Keymap_ESInitialized:Boolean;

var
 {Keymap ES - Spanish}
 KEYMAP_ES_HEADER:TKeymapHeader = (
 ...
 KEYMAP_ES_DATA:TKeymapData = (
  ...
  Data:({SCAN_CODE_NONE                   } (KEY_CODE_NONE,                 KEY_CODE_NONE,                 KEY_CODE_NONE,                 KEY_CODE_NONE),
        ...
        {SCAN_CODE_1                      } (KEY_CODE_1,                    KEY_CODE_EXCLAMATION,          KEY_CODE_PIPE,                 KEY_CODE_NONE),
        {SCAN_CODE_2                      } (KEY_CODE_2,                    KEY_CODE_QUOTATION,            KEY_CODE_AT,                   KEY_CODE_NONE),
        {SCAN_CODE_3                      } (KEY_CODE_3,                    KEY_CODE_MIDDLE_DOT,           KEY_CODE_NUMBER,               KEY_CODE_NONE),
        {SCAN_CODE_4                      } (KEY_CODE_4,                    KEY_CODE_DOLLAR,               KEY_CODE_TILDE,                KEY_CODE_NONE),
        {SCAN_CODE_5                      } (KEY_CODE_5,                    KEY_CODE_PERCENT,              KEY_CODE_EURO,                 KEY_CODE_NONE),
        {SCAN_CODE_6                      } (KEY_CODE_6,                    KEY_CODE_AMPERSAND,            KEY_CODE_NOT,                  KEY_CODE_NONE),
        {SCAN_CODE_7                      } (KEY_CODE_7,                    KEY_CODE_SLASH,                KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_8                      } (KEY_CODE_8,                    KEY_CODE_LEFT_BRACKET,         KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_9                      } (KEY_CODE_9,                    KEY_CODE_RIGHT_BRACKET,        KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_0                      } (KEY_CODE_0,                    KEY_CODE_EQUALS,               KEY_CODE_NONE,                 KEY_CODE_NONE),
        ...
        {SCAN_CODE_MINUS                  } (KEY_CODE_APOSTROPHE,           KEY_CODE_QUESTION,             KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_EQUALS                 } (KEY_CODE_INVERTED_EXCLAMATION, KEY_CODE_INVERTED_QUESTION,    KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_LEFT_SQUARE            } (KEY_CODE_GRAVE,                KEY_CODE_CARET,                KEY_CODE_LEFT_SQUARE,          KEY_CODE_NONE),
        {SCAN_CODE_RIGHT_SQUARE           } (KEY_CODE_PLUS,                 KEY_CODE_ASTERISK,             KEY_CODE_RIGHT_SQUARE,         KEY_CODE_NONE),
        {SCAN_CODE_BACKSLASH              } (KEY_CODE_CEDILLA_C,            KEY_CODE_CAPITAL_CEDILLA_C,    KEY_CODE_RIGHT_BRACE,          KEY_CODE_NONE),
        {SCAN_CODE_NONUS_NUMBER           } (KEY_CODE_CEDILLA_C,            KEY_CODE_CAPITAL_CEDILLA_C,    KEY_CODE_RIGHT_BRACE,          KEY_CODE_NONE),
        {SCAN_CODE_SEMICOLON              } (KEY_CODE_TILDE_N,              KEY_CODE_CAPITAL_TILDE_N,      KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_APOSTROPHE             } (KEY_CODE_ACUTE,                KEY_CODE_DIAERESIS,            KEY_CODE_LEFT_BRACE,           KEY_CODE_NONE),
        {SCAN_CODE_GRAVE                  } (KEY_CODE_MASCULINE,            KEY_CODE_FEMININE,             KEY_CODE_BACKSLASH,            KEY_CODE_NONE),
        {SCAN_CODE_COMMA                  } (KEY_CODE_COMMA,                KEY_CODE_SEMICOLON,            KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_PERIOD                 } (KEY_CODE_PERIOD,               KEY_CODE_COLON,                KEY_CODE_NONE,                 KEY_CODE_NONE),
        {SCAN_CODE_SLASH                  } (KEY_CODE_MINUS,                KEY_CODE_UNDERSCORE,           KEY_CODE_NONE,                 KEY_CODE_NONE),
 ...
 KEYMAP_ES_CAPSKEYS:TKeymapCapskeys = (
  Count:4;
  Keys:((First:SCAN_CODE_A;             Last:SCAN_CODE_Z),
        (First:SCAN_CODE_SEMICOLON;     Last:SCAN_CODE_SEMICOLON),
 ...
 KEYMAP_ES_DEADKEYS:TKeymapDeadkeys = (
  Count:5;
  Keys:((Key:SCAN_CODE_LEFT_SQUARE; {Grave Accent (Normal)}
        ...
        (Key:SCAN_CODE_LEFT_SQUARE; {Circumflex Accent (Shift)}
...
begin
 {}
 {Check Initialized}
 if Keymap_ESInitialized then Exit;

 {Load Spanish (ES) Keymap}
 KeymapHandle:=KeymapLoadEx(@KEYMAP_ES_HEADER,@KEYMAP_ES_DATA,@KEYMAP_ES_CAPSKEYS,@KEYMAP_ES_DEADKEYS,SizeOf(TKeymapData),nil);
 if KeymapHandle = INVALID_HANDLE_VALUE then
  begin
   if PLATFORM_LOG_ENABLED then PlatformLogError('Failed to load keymap ES');
  end;
