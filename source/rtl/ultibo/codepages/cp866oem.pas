{
Ultibo CP866 (OEM) interface unit.
...
===================
 ...
 Note: This unit automatically includes CP1251ANSI as the matching ANSI code page.
...
{==============================================================================}
{type}
 {CP866OEM specific types}

{==============================================================================}
{var}
 {CP866OEM specific variables}
...
begin
 {}
 {Check Initialized}
 if CP866OEMInitialized then Exit;

 {Load Default Code Pages}
 LoadPage(CP_OEM_866,@CPOEM866,nil,nil);
 InstallTrans(CP_OEM_866,@CP866TO1251);

 CP866OEMInitialized:=True;
end;
