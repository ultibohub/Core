...
=====================
 ...
 Note: CP1258 is used as both the ANSI and OEM code pages when selected
...
{==============================================================================}
{type}
 {CP1258ANSI specific types}

{==============================================================================}
{var}
 {CP1258ANSI specific variables}
...
var
 {CP1258ANSI specific variables}
 CP1258ANSIInitialized:Boolean;

 CPANSI1258:TCodeTable = (
  MaxCharSize:1;
  DefaultChar:(
  $3F,$00);
  LeadByte:(
 ...
 CP1258Lower:TLowerTable = (
  ...
  $E0,$E1,$E2,$E3,$E4,$E5,$E6,$E7,$E8,$E9,$EA,$EB,$CC,$ED,$EE,$EF,
  $F0,$F1,$D2,$F3,$F4,$F5,$F6,$D7,$F8,$F9,$FA,$FB,$FC,$FD,$DE,$DF,
 ...
 CP1258Upper:TUpperTable = (
  ...
  $80,$81,$82,$3F,$84,$85,$86,$87,$88,$89,$8A,$8B,$8C,$8D,$8E,$8F,
...
begin
 {}
 {Check Initialized}
 if CP1258ANSIInitialized then Exit;
