 ...
 if TableEntry <> 0 then
  begin
   ...
   if TableEntry <> 0 then
    begin
     {Get Virtual Address}
     Entry.VirtualAddress:=(Address and ARMV7_L2D_SMALL_BASE_MASK);

     {Get Physical Address and Size}
     Entry.PhysicalAddress:=(TableEntry and ARMV7_L2D_SMALL_BASE_MASK);
     Entry.Size:=SIZE_4K;
    ...
    begin
     ...
     if TableEntry <> 0 then
      begin
       {Get Virtual Address}
       Entry.VirtualAddress:=(Address and ARMV7_L2D_LARGE_BASE_MASK);

       {Get Physical Address and Size}
       Entry.PhysicalAddress:=(TableEntry and ARMV7_L2D_LARGE_BASE_MASK);
       Entry.Size:=SIZE_64K;
   ...
   if TableEntry <> 0 then
    begin
     ...
     if (TableEntry and ARMV7_L1D_FLAG_SUPERSECTION) = 0 then
      begin
       {Get Virtual Address}
       Entry.VirtualAddress:=(Address and ARMV7_L1D_SECTION_BASE_MASK);

       {Get Physical Address and Size}
       Entry.PhysicalAddress:=(TableEntry and ARMV7_L1D_SECTION_BASE_MASK);
       Entry.Size:=SIZE_1M;
      end
     else
      begin
       {Get Virtual Address}
       Entry.VirtualAddress:=(Address and ARMV7_L1D_SUPERSECTION_BASE_MASK);

       {Get Physical Address and Size}
       Entry.PhysicalAddress:=(TableEntry and ARMV7_L1D_SUPERSECTION_BASE_MASK);
       Entry.Size:=SIZE_16M;
      end;
